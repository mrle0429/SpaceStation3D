...
public class quat {
    ...
    public quat(float[] matrix) {
        ...
        imag = new Vector4f((matrix[6] - matrix[9]) / w4, (matrix[8] - matrix[2]) / w4, (matrix[1] - matrix[4]) / w4,
                0.0f);
    }
...
//	currentMatrix.
        ...
        // (1.0f-((2.0f*imag.y*imag.y)+(2.0f*imag.z*imag.z))));
        ...
        /*
         * System.out.println("Matrix " + ToConvert[0] +" "+ ToConvert[4] +" "+
         * ToConvert[8] +" "+ ToConvert[12] + "\n" +"       " + ToConvert[1] +" "+
         * ToConvert[5] +" "+ ToConvert[9] +" "+ ToConvert[13] + "\n" +"       " +
         * ToConvert[2] +" "+ ToConvert[6] +" "+ ToConvert[10] +" "+ ToConvert[14] +
         * "\n" +"       " + ToConvert[3] +" "+ ToConvert[7] +" "+ ToConvert[11] +" "+
         * ToConvert[15] + "\n");
         */

        currentMatrix.put(ToConvert[0]).put(ToConvert[1]).put(ToConvert[2]).put(ToConvert[3]).put(ToConvert[4])
                .put(ToConvert[5]).put(ToConvert[6]).put(ToConvert[7]).put(ToConvert[8]).put(ToConvert[9])
                .put(ToConvert[10]).put(ToConvert[11]).put(ToConvert[12]).put(ToConvert[13]).put(ToConvert[14])
                .put(ToConvert[15]).flip();
